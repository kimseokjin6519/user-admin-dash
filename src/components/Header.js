         ...
         <div className="bg-blue-700 text-white p-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
               ...
               <div className="flex items-center">
                  <input type="text" placeholder="Search for users, groups or settings" className="text-xs p-2 rounded-l-lg text-gray-700 w-96 border-0 border-black" style={{ fontFamily: 'Google Sans' }}/>
                  <button className="text-xs bg-white text-blue-600 p-2 rounded-r-lg border-0 border-black border-l-0">🔍</button>
               </div>
            </div>
            ...
            <div className="flex items-center">
               ...
               <button className="text-white">
                  <img src={defaultTasksImage} alt="Default Tasks" className="w-4 h-4 mr-6 rounded-full"/>
               </button> 

               {/* Help Icon */}
            
               <button className="text-white">
                  <div className="flex w-4 h-4 items-center justify-center bg-white mr-10 text-blue-700 rounded-full" style={{ fontFamily: 'Product Sans' }}>?</div>
               </button> 

               {/* Default Apps */}
            
               <button className="text-white">
                  <img src={defaultAppsImage} alt="Default Apps" className="w-4 h-4 bg-blue-700 mr-4"/>
               </button> 
