         ...
         <div className="flex bg-white h-screen justify-center items-center">
            ...
            <div className="flex flex-col w-1/4 h-1/2 justify-center bg-white shadow-md rounded-lg">
               ...
               <div className="flex flex-col items-center mx-4">
                  <input type="text" placeholder="Email" value={email} onChange={(event) => setEmail(event.target.value)} className="w-full h-12 border-2 border-gray-600 px-2 rounded text-gray-400 mb-2 font-light" style={{ fontFamily: 'Product Sans' }} />
                  <input type="password" placeholder="Password" value={password} onChange={(event) => setPassword(event.target.value)} className="w-full h-12 border-2 border-gray-600 px-2 rounded text-gray-400 font-light" style={{ fontFamily: 'Product Sans' }} />
               </div>
