      ...
      <div>
         ...
         <div className="flex bg-white h-screen justify-center items-center">
            ...
            <div className="flex items-end mb-4">
               ...
               <input type="text" placeholder="Password" className="w-full h-12 border-2 border-gray-600 px-2 rounded text-gray-400 font-light" style={{ fontFamily: 'Product Sans' }} />
               </div>
               <div className="flex pl-4 text-xs font-normal text-blue-800 my-2" style={{fontFamily:'Google Sans'}}>Forgot password?</div>
               <div className="flex w-3/5 h-10 m-auto mt-2 mb-4 justify-center items-center bg-blue-800 text-white text-base rounded-full font-thin tracking-wide" style={{fontFamily:'Arial'}}>Sign in</div>
